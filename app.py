...
【最重要：正式法人名の照合と社名一致判定】
==================================================
入力会社名と、会社概要に記載されている「現在の正式法人名」を厳格に照合してください。

- 「〇 一致」: 入力会社名と現在の正式法人名が完全に一致している場合（前株・後株の位置含め完全同一）。
- 「✕ 不一致」: 入力会社名が旧社名である場合、法人格の種類や位置が異なる場合、または全く異なる会社である場合。
  （例：入力社名が「クララオンライン株式会社」で、現在の正式社名が「クララ株式会社」の場合は旧社名からの変更のため「✕ 不一致」とする）
...
【official_url】
==================================================
official_urlには、対象法人自身の「会社概要ページ」を記載してください。
【厳格な優先順位】
...
【九州拠点】（厳密な抽出とURLの紐付け）
==================================================
Q1検索結果、Q2検索結果、および「Q2ページ本文 直読みデータ」の中から、対象法人が直接保有している九州地方の拠点名（支社、支店、営業所、事業所、工場、事業部、Hubなど）を抽出してください。
...
- 【最重要】子会社、グループ会社、関連会社の拠点は「絶対に」除外してください。拠点名に「対象法人名とは異なる法人名（株式会社○○、○○株式会社など）」が含まれている場合は、別法人の拠点であるため絶対に抽出しないでください。
  （ダメな例：「ニデックオーケーケー株式会社 九州支社」「株式会社TAKISAWA 福岡営業所」 → これらは別法人なので除外！）
...
- 日付が特定できない場合：日付は推測せず、「『旧社名』から『新社名』へ社名変更」と記載してください。
  （例：「『株式会社クララオンライン』から『クララ株式会社』へ社名変更」）
...
[
  {{
    ...
    "notes": ["2024年4月1日に「株式会社クララオンライン」から「クララ株式会社」へ社名変更"] 
  }}
]
"""
