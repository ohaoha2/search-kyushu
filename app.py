...
拠点のURLは、入力会社名と完全一致する会社の情報であるか確認してください。

【厳格な禁止ルール】
- 住所、ビル名、電話番号などは出力しないでください。「拠点名のみ」を抽出してください。
- 拠点名がなく住所しか記載されていない場合は、住所を抽出してください。
- 【最重要：子会社・グループ会社の徹底除外】
  入力会社名と完全一致する会社の拠点のみを抽出してください。関連会社、子会社、グループ会社等の拠点は、絶対に抽出しないでください。
...
・【入力会社名】が『過去の旧社名』『グループ再編・統合・合併前の社名』である場合（例：ヤフー株式会社 → LINEヤフー株式会社、株式会社ガリバーインターナショナル → 株式会社IDOM、株式会社日立ハイテクノロジーズ → 株式会社日立ハイテク 等）：
  ...
  （例： [✕ 2016年7月15日に 『株式会社IDOM』へ変更](https://idom-inc.com/ir/company/) ）
