...
提供された検索結果から明確に確認できる場合。

特に対象企業自身の公式サイトの現在の拠点一覧、
事業所一覧、営業所一覧、事業部一覧等に掲載されている場合を優先してください。


"❌九州拠点なし"

対象企業自身の現在の公式情報から、
九州内に対象企業自身の拠点がないことが確認できる場合。

特に以下の場合は「❌九州拠点なし」としてください。

- 対象企業自身の公式な国内拠点一覧・事業所一覧・営業所一覧等を確認でき、
  九州の拠点が掲載されていない場合
- 公式情報上の現在の国内拠点が他地域のみであることが確認できる場合
- 九州に存在するのが子会社・関連会社・別法人のグループ会社の拠点だけで、
  対象企業自身の九州拠点がないことを確認できる場合
...
「九州拠点の情報が見つからない」という理由だけでは❌にしないでください。

対象企業自身の九州拠点があるかないかを、
提供された検索結果だけでは確定できない場合に使用してください。


重要：

「⭕️九州拠点あり」と判定するには、
少なくとも以下の3点を確認できる必要があります。
...
対象企業が持株会社・親会社等である場合、
子会社・関連会社・別法人のグループ会社の拠点を
対象企業自身の九州拠点として扱わないでください。

例えば、

「ニデック株式会社」の判定で
「ニデックテクノモータ株式会社 九州事業所」が確認された場合、

ニデックテクノモータ株式会社は別法人なので、
それを「ニデック株式会社自身の九州拠点」としてdetailsに記載してはいけません。

対象企業自身の公式情報から、
九州にあるのが別法人の拠点だけであり、
対象企業自身の九州拠点がないことが確認できる場合は
「❌九州拠点なし」としてください。

ただし、別法人の拠点しか確認できず、
対象企業自身の九州拠点の有無を公式情報から確定できない場合は
「❓判定不明」としてください。
...
公式サイト内の現在の「事業所一覧」「拠点一覧」「営業所一覧」等を最優先してください。

対象企業自身の公式サイトに現在の事業拠点として掲載されている場合は、
第三者情報の有無にかかわらず、公式情報を優先して「⭕️九州拠点あり」としてください。

公式サイトと第三者情報が矛盾する場合は、
原則として公式情報を優先してください。

Yahoo!、求人サイト、企業情報サイト、ニュースサイト、
まとめサイト等の第三者情報だけを根拠として「⭕️九州拠点あり」と判定してはいけません。
...
ただし、過去の公式な拠点情報と、
現在の公式サイトで同じ事業・部門が継続していることを示す情報を組み合わせて、
現在もその事業拠点が稼働していることを合理的に確認できる場合は
「⭕️九州拠点あり」と判定してください。
...
個別のニュース記事や古い移転告知よりも、その現在の一覧ページを優先してください。
...
同じ企業の「法人事業部 福岡」「法人営業部 福岡」等が確認できる場合は、
営業・事業拠点を優先してください。
...
❌の場合：
対象企業自身に九州拠点がないこと、
または対象企業自身の公式拠点一覧に九州がないこと、
または九州にあるのが別法人の拠点だけであることなど、
判定の根拠を記載してください。
