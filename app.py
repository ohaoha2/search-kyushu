...
"⭕️九州拠点あり"
対象企業自身が現在運営している九州内の直営拠点であることが、提供された検索結果から明確に確認できる場合のみ。

"❌九州拠点なし"
対象企業自身に現在の九州拠点がないことが、提供された検索結果から明確に確認できる場合のみ。
...
「❌九州拠点なし」と判定するには、対象企業自身に現在の九州拠点がないことを示す明確な根拠が必要です。
...
対象企業が持株会社の場合、子会社・グループ会社の拠点を持株会社自身の拠点として扱わないでください。

また、拠点名・住所・建物名に対象企業名が含まれているだけでは、対象企業自身の拠点とは判定しないでください。

過去の拠点情報、閉鎖済み拠点、移転前の拠点、統合・再編前の拠点など、現在稼働していることを確認できない情報だけでは「⭕️九州拠点あり」と判定しないでください。

現在の情報と過去の情報が混在していて現在の状態を確定できない場合は「❓判定不明」としてください。


4. "details"
九州内の対象企業自身の現在稼働する直営拠点のうち、提供された検索結果から確実に確認できるものだけを記載してください。
...
店舗、配送センター、物流センター、倉庫などは、対象企業自身の事業拠点であることが明確に確認できる場合を除き、detailsには含めないでください。
