...
2. "official_url": その企業ののコーポレートサイトURL（Wikipedia、求人サイト、ニュースサイトは除外。見つからない場合は null）
3. "is_found": 九州地方（福岡, 佐賀, 長崎, 熊本, 大分, 宮崎, 鹿児島）に、現在稼働している【直営の支店、営業所、工場、事業所】が明確に裏付けられる場合のみ true としてください。以下の場合は必ず false にしてください：
   - ネット上に明確な直営拠点の記載がない場合（憶測や「かつてあった」情報）
