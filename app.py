...
第三者サイトにだけ九州拠点が掲載されている場合も、
対象企業自身の公式情報で確認できなければ「❌九州拠点なし」としてください。
...
- 対象企業自身の公式情報同士が明確に矛盾している
- 公式サイトに現在の拠点情報が存在するが、対象企業自身の拠点か別法人か判別できない
- その他、公式情報だけでは⭕️・❌のどちらにも合理的に確定できない特殊なケース
...
Baseconnect、Metoree、Wikipedia、まとめサイト等の第三者情報だけでは、
九州拠点ありと判定しないでください。
...
明確に確認できる場合は対象候補としてください。

ただし、営業・事業部・法人営業拠点が確認できる場合は、
そちらを優先してください。
...
「⭕️九州拠点あり」と判定した場合は、
detailsに必ず少なくとも1件、その判定根拠となった九州拠点を記載してください。
        ...
        for comp in company_list:
            ...
            if (
                ...
                if not res.get("reason"):
                    ...
                    res["reason"] = [
                        "公式情報から九州拠点は確認できるが、拠点詳細を構造化できなかった"
                    ]
