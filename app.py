...
3. "details": 九州内の確実な直営拠点ごとの詳細情報（名称, 住所, 直営拠点を裏付けるURL）のリスト（見つからない場合は空配列 []）。対象企業自身が運営する拠点のみを対象とし、子会社・関連会社・グループ会社など別法人の拠点は含めないでください。
4. "is_found": 九州地方（福岡, 佐賀, 長崎, 熊本, 大分, 宮崎, 鹿児島）に、現在稼働している対象企業自身の直営の支店、営業所、工場、事業所、その他の事業部・営業拠点が明確に裏付けられる場合のみ trueとしてください。以下の場合は必ず false にしてください：
...
6. "notes": 提供された検索結果の中に、ここ3年以内の以下のいずれかの重要トピックがある場合のみ、短い名詞句で簡潔に記載してください。
   - 社名変更・商号変更
   - 拠点新設、移転、拡張
   - M&A、グループ再編、組織変更
   - 新規事業立ち上げや大規模な設備投資
