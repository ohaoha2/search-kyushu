...
3. "details": 九州内の確実な直営・自社運営の事業拠点ごとの詳細情報（名称, 住所, 直営拠点を裏付けるURL）のリスト（見つからない場合は空配列 []）
4. "is_found": 九州地方（福岡, 佐賀, 長崎, 熊本, 大分, 宮崎, 鹿児島）に、現在稼働している直営の支店、営業所、工場、事業所、その他の自社運営の事業部・営業拠点が明確に裏付けられる場合のみ true としてください。以下の場合は必ず false にしてください：
