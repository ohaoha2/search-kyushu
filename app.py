...
【厳格な禁止ルール】
- 住所、ビル名、階数、電話番号などは出力しないでください。「拠点名のみ」を抽出してください。ただし、拠点名の記載がない場合は住所でも可。
- 【最重要：子会社・グループ会社の徹底除外】
  入力会社名と完全一致する会社の拠点のみを抽出してください。子会社やグループ会社の拠点は、絶対に抽出しないでください。
- 小売店舗そのもの（販売店）は除外してください。ただし店舗内に「法人事業部」等がある場合は抽出可。

==================================================
【company_match】（社名判定の厳格ルール）
==================================================
1. 検索結果の会社概要から対象企業の【現在の正式法人名】を特定する。
