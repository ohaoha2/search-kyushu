...
対象企業自身の公式サイト・公式発表等で明確に確認できる場合。


"❌九州拠点なし"

対象企業自身の公式サイト・公式発表等を確認しても、
現在の九州内拠点が確認できない場合。

今回の実務上の判定では、
「公式に現在の九州拠点が確認できない」場合は原則として
「❌九州拠点なし」としてください。

特に対象企業自身の公式サイトに
「拠点一覧」「事業所一覧」「営業所一覧」「国内拠点一覧」
などがある場合は、その情報を基準にしてください。

その公式情報に九州の拠点が掲載されていなければ、
「❌九州拠点なし」としてください。


"❓判定不明"

公式情報と第三者情報が矛盾している場合や、
公式情報が特殊・不十分で、現在の九州拠点の有無を確定できない
例外的な場合のみ使用してください。

単に「公式サイトに九州拠点が見つからない」という理由だけで
「❓判定不明」にしないでください。


重要：

「⭕️九州拠点あり」と判定するには、少なくとも以下を確認してください。
...
別法人の九州拠点しか確認できない場合は、
それをdetailsに含めないでください。

対象企業自身の公式情報で九州拠点が確認できなければ、
原則「❌九州拠点なし」としてください。
...
公式サイト内の現在の
「事業所一覧」「拠点一覧」「営業所一覧」等を最優先してください。

対象企業自身の公式サイトに現在の九州拠点が掲載されている場合は、
第三者情報の有無にかかわらず「⭕️九州拠点あり」としてください。

Yahoo!、求人サイト、企業情報サイト、ニュースサイト、
まとめサイト等の第三者情報だけを根拠として「⭕️九州拠点あり」
と判定してはいけません。
...
ただし、過去の公式な拠点情報と、
現在の公式サイトで同じ事業・部門が継続していることを示す情報を
組み合わせて、現在も同じ事業拠点が稼働していることを
合理的に確認できる場合は「⭕️九州拠点あり」としてください。

現在も稼働していることを確認できない場合は、
原則として「❌九州拠点なし」としてください。

ただし、公式情報同士が矛盾していて判断できない場合は
「❓判定不明」としてください。
...
対象企業自身が運営する恒常的な事業部・営業拠点であれば対象としてください。

公式サイト内に「事業所一覧」「拠点一覧」「営業所一覧」等のページがある場合は、
個別のニュース記事や古い移転告知よりも、
現在の一覧ページを優先してください。

営業・事業部・法人営業拠点と物流・配送拠点の両方が確認できる場合は、
営業・事業部・法人営業拠点を優先してください。

物流センター、配送センター、DC、倉庫等も、
対象企業自身が現在運営する恒常的な事業拠点であることが確認できる場合は
対象候補としてください。

ただし、別法人が運営する物流施設・配送施設は対象外です。

別法人の子会社・関連会社・グループ会社の拠点、
代理店、販売店、顧客先、単なる配送先・納品先は対象外です。
...
判定にかかわらず、今回の判定に至った主な根拠を1～2個、
簡潔に記載してください。

提供された検索結果から確認できる事実に基づき、
推測・憶測はしないでください。

⭕️の場合：
対象企業自身の現在の公式情報など、判定の直接的な根拠。

❌の場合：
対象企業自身の公式情報に九州拠点が掲載されていないこと、
現在の公式拠点一覧に九州がないこと、
または九州に確認できるのが別法人の拠点だけであること等。

❓の場合：
公式情報同士の矛盾など、なぜ通常の⭕️/❌判定ができないのか。
