...
前株・後株が異なる場合、
他の情報が似ていても絶対に「〇 一致」にしてはいけません。


【1. official_url】

入力された会社名の対象企業自身の公式サイトを選択してください。
...
ただし、そのURLのドメインが対象企業自身の公式サイトであることを
必ず確認してください。

Wikipedia、求人サイト、ニュースサイト、
企業情報まとめサイト、業界団体サイトなどは
対象企業自身の公式サイトではありません。
...
などのページに対象企業の情報が掲載されていても、
それを対象企業の公式サイトとして選んではいけません。

検索結果に存在するURLだけを使用してください。
URLを推測して作成してはいけません。

公式サイトを確認できなければ null としてください。
...
会社概要等から正式名称が確認できる場合は、
入力会社名と文字列として照合してください。
...
「九州各県」
「福岡エリア」
など具体的住所のないものは除外してください。


【4. department_keywords】

会社の部署ごとに、
IT営業で提案できる具体的なキーワードを返してください。
